...
/******************************************************************************/
describe("POST /2/1/cantidad/8", function () {
	it("Cambia la cantidad del pedido 1 de 1 a 8", async function () {
			const response = await supertest.post("/2/1/cantidad/8")
			expect(response.status).to.eql(200)
...
/******************************************************************************/
describe("POST /2/1/id/8", function () {
	it("Cambia el id del pedido 1 de 1 a 8", async function () {
			const response = await supertest.post("/2/1/id/8")
			expect(response.status).to.eql(200)
			expect(response.text).to.be.a("string").to.include("8")
...
/******************************************************************************/
describe("PUT /2/nuevopedido/100/8", function () {
	it("Crea un nuevo pedido con id 100 y cantidad 8", async function () {
			const response = await supertest.put("/2/nuevopedido/100/8")
			expect(response.status).to.eql(200)
...
/******************************************************************************/
describe("POST /2/100/ingredientes/Curry,Otro", function () {
	it("Incluye en el pedido 8 los ingredientes a evitar curry y otro", async function () {
			const response = await supertest.post("/2/100/ingredientes/Curry,Otro")
			expect(response.status).to.eql(200)
...
/******************************************************************************/
describe("POST /2/usuarios/8", function () {
	it("Cambia el numero de personas de la mesa 2 a 8", async function () {
			const response = await supertest.post("/2/usuarios/8")
			expect(response.status).to.eql(200)
		});
});
